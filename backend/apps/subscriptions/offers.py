...
def subscription_offer_for_plan(plan, *, user=None) -> dict[str, object]:
    ...
    payload = {
        **offer,
        ...
        "spotlights_quota": capabilities["spotlights"]["quota"],
        "spotlights_label": capabilities["spotlights"]["label"],
        "direct_chat_label": capabilities["messaging"]["label"],
