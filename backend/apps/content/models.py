...
class ContentBlockKey(models.TextChoices):
    ...
    HOME_HERO_TITLE = "home_hero_title", "الرئيسية - عنوان الهيرو"
    HOME_HERO_SUBTITLE = "home_hero_subtitle", "الرئيسية - الوصف المختصر"
    HOME_SEARCH_PLACEHOLDER = "home_search_placeholder", "الرئيسية - نص البحث"
