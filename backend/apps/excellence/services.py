...
DEFAULT_EXCELLENCE_BADGES = [
    {
        ...
        "icon": "sparkles",
        "color": "#C0841A",
        "description": "تُمنح لأعلى مقدم خدمة تقييمًا داخل فئته.",
        "description_en": "Awarded to the top-rated provider within their category.",
    ...
    },
    {
        ...
        "icon": "bolt",
        "color": "#0F766E",
        "description": "تُمنح لأعلى مقدم خدمة في الطلبات المكتملة خلال آخر 365 يومًا داخل تصنيفه، بشرط تجاوز 100 طلب مكتمل.",
        "description_en": "Awarded to the top provider by completed orders during the last rolling 365 days within their category, provided they exceed 100 completed orders.",
        "review_cycle_days": 90,
        "sort_order": 20,
    },
    {
        ...
        "icon": "trophy",
        "color": "#7C3AED",
        "description": "تُمنح لأعلى مقدم خدمة في عدد المتابعين داخل تصنيفه، بشرط تجاوز 100 متابع.",
        "description_en": "Awarded to the most-followed provider within their category, provided they exceed 100 followers.",
        "review_cycle_days": 90,
        "sort_order": 30,
    },
]
