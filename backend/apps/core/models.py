...
class PlatformConfig(models.Model):
    ...
    def load(cls) -> "PlatformConfig":
        ...
        try:
            ...
            # Database schema may lag behind code during deploy windows.
            # Return an in-memory default object so read paths do not 500.
            logger.exception("PlatformConfig schema mismatch; using in-memory defaults")
            obj = cls(pk=1)
