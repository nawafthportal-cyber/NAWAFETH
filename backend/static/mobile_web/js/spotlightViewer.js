...
const SpotlightViewer = (() => {
  ...
  function _shareCopy(key) {
    ...
    const copy = {
      ...
      reportSubtitle: isEnglish ? 'This report goes to the content moderation team.' : 'سيصل هذا البلاغ مباشرة إلى لوحة فريق إدارة المحتوى.',
      ...
      reportSuccess: isEnglish ? 'Report sent to the content team.' : 'تم إرسال البلاغ إلى فريق المحتوى.',
