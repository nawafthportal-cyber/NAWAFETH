...
PROMO_HOME_BANNER_ENFORCE_EXACT_DIMENSIONS = env_bool(
    "PROMO_HOME_BANNER_ENFORCE_EXACT_DIMENSIONS",
    not USE_R2_MEDIA,
)
PROMO_HOME_BANNER_MIN_DIMENSIONS = env_json(
    "PROMO_HOME_BANNER_MIN_DIMENSIONS",
    [960, 420],
)
try:
    PROMO_HOME_BANNER_MIN_RATIO = float(os.getenv("PROMO_HOME_BANNER_MIN_RATIO", "1.60") or "1.60")
except Exception:
    PROMO_HOME_BANNER_MIN_RATIO = 1.60
try:
    PROMO_HOME_BANNER_MAX_RATIO = float(os.getenv("PROMO_HOME_BANNER_MAX_RATIO", "3.60") or "3.60")
except Exception:
...
OTP_PHONE_DAILY_BLOCK_SECONDS = int(os.getenv("OTP_PHONE_DAILY_BLOCK_SECONDS", "180"))
