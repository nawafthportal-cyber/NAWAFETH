...
DJANGO_FORCE_STATIC_FALLBACK = env_bool("DJANGO_FORCE_STATIC_FALLBACK", False)
STATICFILES_MANIFEST_BACKEND = "whitenoise.storage.CompressedManifestStaticFilesStorage"
STATICFILES_FALLBACK_BACKEND = "django.contrib.staticfiles.storage.StaticFilesStorage"
STATICFILES_BACKEND = (
    STATICFILES_FALLBACK_BACKEND
    if DJANGO_FORCE_STATIC_FALLBACK
    else STATICFILES_MANIFEST_BACKEND
)
STATICFILES_STORAGE = STATICFILES_BACKEND
WHITENOISE_MANIFEST_STRICT = env_bool("WHITENOISE_MANIFEST_STRICT", False)
WHITENOISE_USE_FINDERS = DJANGO_FORCE_STATIC_FALLBACK
